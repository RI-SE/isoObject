...
public:
	...
	std::string getName() const {
		return stateNames.at(getStateID());
	}
...
public:
	virtual ObjectStateID getStateID() const final override {
		return ISO_OBJECT_STATE_UNKNOWN;
	}

private:
	void handleTRAJ(TestObject&, std::atomic<HeaderType>&) final override {
		unexpectedMessageWarning("TRAJ");
	}
	void handleOSEM(TestObject&, ObjectSettingsType&) final override {
		unexpectedMessageWarning("OSEM");
	}
	void handleOSTM(TestObject&, ObjectCommandType&) final override {
		unexpectedMessageWarning("OSTM");
	}
	void handleSTRT(TestObject&, StartMessageType&) final override {
		unexpectedMessageWarning("STRT");
	}
};
...
public:
	virtual ObjectStateID getStateID() const final override {
		return ISO_OBJECT_STATE_DISARMED;
	}
...
public:
	virtual ObjectStateID getStateID() const final override {
		return ISO_OBJECT_STATE_RUNNING;
	}
};
...
public:
	virtual ObjectStateID getStateID() const final override {
		return ISO_OBJECT_STATE_POSTRUN;
	}
};
...
public:
	virtual ObjectStateID getStateID() const final override {
		return ISO_OBJECT_STATE_REMOTE_CONTROLLED;
	}
};
class Aborting : public State {
public:
	virtual ObjectStateID getStateID() const final override {
		return ISO_OBJECT_STATE_ABORTING;
	}
};
...
public:
	virtual ObjectStateID getStateID() const final override {
		return ISO_OBJECT_STATE_PRE_ARMING;
	}
	virtual void onEnter(TestObject& obj) {
		this->handleEvent(obj, Events::N);
	}
};
...
public:
	virtual ObjectStateID getStateID() const final override {
		return ISO_OBJECT_STATE_PRE_RUNNING;
	}
	virtual void onEnter(TestObject& obj) {
		this->handleEvent(obj, Events::T);
	}
};
